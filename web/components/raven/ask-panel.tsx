...
export function AskPanel({
  ...
  const idle = !ask.isPending && !ask.data && !ask.error;
...
// /ask returns nothing until it is finished, so there is no progress to show.
// Naming the steps is honest where a percentage would not be.
const STEPS = [
